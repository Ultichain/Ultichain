Contributing to Ultichain Core
============================

The Ultichain Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to ultichain-qt
...
[Translation Process](https://github.com/ultichainpay/ultichain/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Ultichain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Ultichain
Network Protocol consensus changes.

Whether a pull request is merged into Ultichain Core rests with the project merge
...
Patches that change Ultichain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ultichain consensus, it must have been
...
The review process is normally fairly responsive on the Ultichain Core repository, however
...
The project leader is the release manager for each Ultichain Core release.
