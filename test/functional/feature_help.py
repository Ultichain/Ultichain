...
"""Verify that starting ultichaind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ultichaind with -h for help text")
        ...
        self.log.info("Start ultichaind with -version for version information")
