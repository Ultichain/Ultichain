...
"""Test the ultichain specific ZMQ notification interfaces."""
...
from test_framework.test_framework import (
     UltichainTestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class UltichainZMQTest (UltichainTestFramework):
    def set_test_params(self):
        ...
        self.set_ultichain_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that ultichaind has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all ultichain related ZMQ publisher
