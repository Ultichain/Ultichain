...
"""Tests around ultichain governance objects."""
...
class UltichainGovernanceTest (UltichainTestFramework):
    def set_test_params(self):
        self.set_ultichain_test_params(2, 1)
