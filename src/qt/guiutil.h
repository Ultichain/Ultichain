...
/** Utility functions used by the Ultichain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ultichain:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load ultichain specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a ultichain specific theme is activated (light/dark).*/
