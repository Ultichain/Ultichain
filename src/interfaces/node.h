...
//! Interface for the src/evo part of a ultichain node (ultichaind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a ultichain node (ultichaind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a ultichain node (ultichaind process).
...
//! Top-level interface for a ultichain node (ultichaind process).
class Node
{
public:
    virtual ~Node() {}
