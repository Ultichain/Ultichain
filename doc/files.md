...
* ultichain.conf: contains configuration settings for ultichaind or ultichain-qt
* ultichaind.pid: stores the process id of ultichaind while running
...
* debug.log: contains debug information and general logging generated by ultichaind or ultichain-qt
