...
This mechanism has been integrated into Bitcore-Node-Ultichain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ultichainpay/insight-api-ultichain#web-socket-api](https://github.com/ultichainpay/insight-api-ultichain#web-socket-api)
* API: [https://github.com/ultichainpay/insight-api-ultichain#instantsend-transactions](https://github.com/ultichainpay/insight-api-ultichain#instantsend-transactions)
