...
Arguments:
    <base_directory> - The base directory of a Ultichain Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Ultichain Core developers'
...
Arguments:
    <base_directory> - The base directory of Ultichain Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Ultichain Core repository.
"""
